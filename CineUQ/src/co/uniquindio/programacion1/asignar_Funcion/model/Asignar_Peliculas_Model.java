...
public class Asignar_Peliculas_Model {
	...
	public ArrayList getFuncion () {
		...
		String tadeo = "Tadeo Jones 3, 90 Min, Clasificacion +7, Sinopsis: El sueño más grande de Tad es ser aceptado por sus colegas arqueólogos, pero su naturaleza accidentada se interpone. Cuando él, inadvertidamente, destruye un sarcófago extraño, se conjura un hechizo que pone en peligro la vida de sus amigos.";
